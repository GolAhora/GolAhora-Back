...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260605035617_FirstMigration")]
            ...
            modelBuilder.Entity("Domain.Entities.Cancha", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("217614b8-c084-48a1-ab6c-8bb4ffa718b5"),
                            Estado = 1,
                            Numero = 1,
                            TipoCanchaId = new Guid("6d21c6cd-b52c-4362-b12c-34c84f4435bf")
                        },
                        new
                        {
                            Id = new Guid("1dbaa27a-1bd1-48f7-adff-276e3e8739e8"),
                            Estado = 1,
                            Numero = 2,
                            TipoCanchaId = new Guid("6d21c6cd-b52c-4362-b12c-34c84f4435bf")
                        },
                        new
                        {
                            Id = new Guid("9ae664f4-9ed2-4165-b050-781a2c54b27d"),
                            Estado = 3,
                            Numero = 3,
                            TipoCanchaId = new Guid("c76e22b1-393a-456c-8619-c9e024805223")
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.TipoCancha", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6d21c6cd-b52c-4362-b12c-34c84f4435bf"),
                            Capacidad = 10,
                            DuracionMax = 2.0,
                            Nombre = "Futbol 5",
                        ...
                        new
                        {
                            Id = new Guid("c76e22b1-393a-456c-8619-c9e024805223"),
                            Capacidad = 22,
                            DuracionMax = 2.0,
                            Nombre = "Futbol 11",
                            PrecioBaseHora = 5000.0,
