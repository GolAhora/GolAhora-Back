...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260604023418_InitialCreate")]
            ...
            modelBuilder.Entity("Domain.Entities.Cancha", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("db597ead-4733-4e5c-8775-69328d654974"),
                            Estado = 1,
                            Numero = 1,
                            TipoCanchaId = new Guid("47f915e4-4de7-4514-a7c6-a8e1cdfe7aa7")
                        },
                        new
                        {
                            Id = new Guid("2ca0ae80-a025-4dde-b5a9-176ffb8731b7"),
                            Estado = 1,
                            Numero = 2,
                            TipoCanchaId = new Guid("47f915e4-4de7-4514-a7c6-a8e1cdfe7aa7")
                        },
                        new
                        {
                            Id = new Guid("1f09a8b8-488b-44f0-8d7d-7c77c707c843"),
                            Estado = 3,
                            Numero = 3,
                            TipoCanchaId = new Guid("bb05ba9b-7675-4736-b1d5-0cf924507a61")
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.TipoCancha", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("47f915e4-4de7-4514-a7c6-a8e1cdfe7aa7"),
                            Capacidad = 10,
                            DuracionMax = 2.0,
                            Nombre = "Futbol 5",
                        ...
                        new
                        {
                            Id = new Guid("bb05ba9b-7675-4736-b1d5-0cf924507a61"),
                            Capacidad = 22,
                            DuracionMax = 2.0,
                            Nombre = "Futbol 11",
                            PrecioBaseHora = 5000.0,
